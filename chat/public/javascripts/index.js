...
socket.on("leave",function(data){
	...
	changeTitle("",data.username,"刚刚走了");
})
...
function updateOnline(usernames){
	...
	$select_users.append("<option>所有用户</optioin>");
	$users_dl.append($("<dt>在线用户</dt>"));
	var i=0;
	if(first_time){
